...
#define PRINT   printf
#else
#define PRINT(...)  // Note: It is variadic macros
#endif
...
{
// Note: Defining `_DEBUG` in "ecs.cpp" has no impact on the conditional
// inclusion, because `gcc` will generate the object file of this separate
// source file, so the source file will not contain the macro.
#ifdef _DEBUG
